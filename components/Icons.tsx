...
export const MotoIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => (
    <span {...props} role="img" aria-label="MotoGP Logo">🏍️</span>
);

export const F1Icon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => (
    <span {...props} role="img" aria-label="F1 Logo">🏎️</span>
);
...
export const LightBulbIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-1.5c1.5-1.5 1.5-3.75 0-5.25S10.5 3.75 9 5.25s-1.5 3.75 0 5.25c.48.48.982.898 1.5 1.246M12 18h.008v.008H12v-.008zm0 0h.008v.008H12v-.008zm0-10.5h.008v.008H12V7.5zm0 0h.008v.008H12V7.5z" />
  </svg>
);
...
export const TrophyIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M4.5 3.75a3 3 0 00-3 3v10.5a3 3 0 003 3h15a3 3 0 003-3V6.75a3 3 0 00-3-3h-15zm4.125 3a2.25 2.25 0 100 4.5 2.25 2.25 0 000-4.5zm-3.875 3a.75.75 0 01.75-.75h2.25a.75.75 0 010 1.5H5.5a.75.75 0 01-.75-.75zM18.75 9.75a.75.75 0 00-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 00.75-.75v-.008a.75.75 0 00-.75-.75h-.008zM18 12.75a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75h-.008a.75.75 0 01-.75-.75v-.008zM15.75 9.75a.75.75 0 00-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 00.75-.75v-.008a.75.75 0 00-.75-.75h-.008zM15 12.75a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75h-.008a.75.75 0 01-.75-.75v-.008z" clipRule="evenodd" />
  </svg>
);
...
export const UsersIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.226c-3.423 0-6.236 2.01-6.236 4.5 0 2.49 2.813 4.5 6.236 4.5 3.422 0 6.235-2.01 6.235-4.5 0-2.49-2.813-4.5-6.235-4.5zM12 7.5a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" />
  </svg>
);
...
export const FireIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path fillRule="evenodd" d="M12.963 2.286a.75.75 0 00-1.071 1.052A9.75 9.75 0 0110.5 18.75a.75.75 0 001.071 1.052A11.25 11.25 0 0021 12a.75.75 0 00-1.071-1.052A9.75 9.75 0 0112.963 2.286z" clipRule="evenodd" />
      <path fillRule="evenodd" d="M8.328 3.228a.75.75 0 00-1.06 1.06A11.25 11.25 0 003 12a.75.75 0 001.06 1.06A9.75 9.75 0 018.328 3.228z" clipRule="evenodd" />
    </svg>
);
