...
export const MotoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9.375-5.375a.75.75 0 0 0-1.5 0v4.5a.75.75 0 0 0 1.5 0v-4.5Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.98 8.48a.75.75 0 0 0-1.428-.532l-2.022 5.054a.75.75 0 0 0 .93 1.03l2.022-5.054a.75.75 0 0 0-.5-1.5Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 15.75a.75.75 0 0 0 1.5 0v-4.5a.75.75 0 0 0-1.5 0v4.5Z" />
    </svg>
);
...
export const TrophyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.75v3.75m-1.5-3.75v3.75m-1.5 3.75h4.5m-4.5 0a3.75 3.75 0 0 1-3.75-3.75V3.75m0 11.25a3.75 3.75 0 0 0 3.75 3.75m0 0h1.5m-1.5 0a3.75 3.75 0 0 1-3.75-3.75M12 3.75v3.75m0 0a3.75 3.75 0 0 1 3.75 3.75M12 7.5h1.5m-1.5 0a3.75 3.75 0 0 0-3.75 3.75m3.75-3.75a3.75 3.75 0 0 1 3.75 3.75m0 0h-4.5m4.5 0a3.75 3.75 0 0 0 3.75-3.75V3.75m0 11.25a3.75 3.75 0 0 1-3.75 3.75m-1.5-15h1.5" />
    </svg>
);
...
export const UserPlusIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3.75 15.75v-1.5a3.375 3.375 0 0 1 3.375-3.375h6.75a3.375 3.375 0 0 1 3.375 3.375v1.5" />
    </svg>
);
...
export const LogoutIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15m-3 0-3-3m0 0 3-3m-3 3H9" />
    </svg>
);
